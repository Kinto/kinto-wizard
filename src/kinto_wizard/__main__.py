...
async def execute():
    ...
    subparser.add_argument(
        "--attachments", help="Load attachments from specified folder",
        default=None
    )
    ...
    subparser.add_argument("--attachments", help="Export collections' attachments to specified folder", default=None)
